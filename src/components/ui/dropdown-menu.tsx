...
const DropdownMenuSubTrigger = React.forwardRef<
  ...
  { icon?: React.ReactNode } & React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.SubTrigger> & {
      inset?: boolean;
    }
...
const DropdownMenuIconItem = React.forwardRef<
  React.ElementRef<typeof DropdownMenuPrimitive.CheckboxItem>,
  { icon?: React.ReactNode } & React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.CheckboxItem>
...
DropdownMenuIconItem.displayName = DropdownMenuPrimitive.CheckboxItem.displayName;
